...
enum _mlan_ioctl_req_id {
	...
	MLAN_OID_MISC_TDLS_TEARDOWN = 0x00200027,
	MLAN_OID_MISC_TDLS_ADD_STA = 0x00200028,
};
...
typedef struct _mlan_ds_misc_cfg {
	...
	/** peer mac for MLAN_OID_MISC_TDLS_TEARDOWN/MLAN_OID_MISC_TDLS_ADD_STA */
		t_u8 tdls_peer_mac[6];
