...
mlan_status wlan_misc_ioctl_tdls_oper(IN pmlan_adapter pmadapter,
				      IN pmlan_ioctl_req pioctl_req);
mlan_status wlan_misc_ioctl_tdls_add_sta(IN pmlan_adapter pmadapter,
					 IN pmlan_ioctl_req pioctl_req);
mlan_status wlan_misc_ioctl_tdls_teardown(IN pmlan_adapter pmadapter,
					  IN pmlan_ioctl_req pioctl_req);
